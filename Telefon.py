# ==========================================
# LOYIHA: Global Translator Phone Inspector v5.2
...
# --- DASTUR MENYUSI ---
print('🛡️ GLOBAL TRANSLATOR PHONE INSPECTOR v5.2 🛡️')
print('-' * 50)
target = input("Telefon modelini kiriting (masalan: Redmi 8A, iPhone 15): ").strip()
